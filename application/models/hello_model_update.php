...
class hello_model_update extends CI_Model 
{
 ...
 function updaterecords($name,$id,$The_brand,$Price_of_the_brand)
 {
 $query=$this->db->query("update telephone SET name='$name',id='$id',The_brand='$The_brand',Price_of_the_brand='$Price_of_the_brand' where id='".$id."'");
 } 
}
?>